...
1.  How many observations (rows) does the dataset have? Instead of hard coding the number in your answer, use inline code. **There are 13245 rows of data in the set.** 
2.  Run `View(edibnb)` in your Console to view the data in the data viewer. What does each row in the dataset represent? **It represents an airbnb in Edinburgh and gives information on each airbnb.**
...
https://9107b0205a6e479f9262003fcff7d6b0.app.posit.cloud/graphics/46553fca-8530-4afe-b5e5-6f867923c615.png
🧶 ✅ ⬆️ Knit, *commit, and push your changes to GitHub with an appropriate commit message. Make sure to commit and push all changed files so that your Git pane is cleared up afterwards.*
